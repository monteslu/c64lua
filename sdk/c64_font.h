/* c64_font.h - original 3x5 pixel font for print(), 4px advance.
 * 5 bytes per glyph, low 3 bits per row (bit2 = left pixel).
 * Order: 0-9, A-Z, space ! - : . /                                  */
static const unsigned char c64_font[42][5] = {
...
/* c64_glyph() lives with the print block in c64_api.c (bank 0 under
